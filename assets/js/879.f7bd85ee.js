"use strict";(self.webpackChunkmy_website=self.webpackChunkmy_website||[]).push([["879"],{50487(e,t,a){function i(e,t){e.accDescr&&t.setAccDescription?.(e.accDescr),e.accTitle&&t.setAccTitle?.(e.accTitle),e.title&&t.setDiagramTitle?.(e.title)}a.d(t,{S:()=>i}),(0,a(1019).K2)(i,"populateCommonDb")},64866(e,t,a){a.d(t,{diagram:()=>k});var i=a(50487),l=a(46792),r=a(74505),s=a(1019),n=a(78731),o=a(80257),c=s.UI.pie,p={sections:new Map,showData:!1,config:c},d=p.sections,g=p.showData,u=structuredClone(c),m=(0,s.K2)(()=>structuredClone(u),"getConfig"),f=(0,s.K2)(()=>{d=new Map,g=p.showData,(0,s.IU)()},"clear"),h=(0,s.K2)(({label:e,value:t})=>{d.has(e)||(d.set(e,t),s.Rm.debug(`added new section: ${e}, with value: ${t}`))},"addSection"),x=(0,s.K2)(()=>d,"getSections"),w=(0,s.K2)(e=>{g=e},"setShowData"),S=(0,s.K2)(()=>g,"getShowData"),y={getConfig:m,clear:f,setDiagramTitle:s.ke,getDiagramTitle:s.ab,setAccTitle:s.SV,getAccTitle:s.iN,setAccDescription:s.EI,getAccDescription:s.m7,addSection:h,getSections:x,setShowData:w,getShowData:S},D=(0,s.K2)((e,t)=>{(0,i.S)(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},"populateDb"),T={parse:(0,s.K2)(async e=>{let t=await (0,n.qg)("pie",e);s.Rm.debug(t),D(t,y)},"parse")},$=(0,s.K2)(e=>`
  .pieCircle{
